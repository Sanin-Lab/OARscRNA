...
We can calculate OAR scores with a single line of code. We recommend you follow the introductory tutorials for a full description of this function. The result is a Seurat object with `OARscore`, `KW.pvalue`, `KW.BH.pvalue` and `sparsity` values in the `meta.data` slot.

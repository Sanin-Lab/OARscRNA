...
In this vignette we will explore what genes are associated with increased OAR scores. We will use our toy plasmacytoid dendritic cell dataset that you can download from our [github repository](https://github.com/davidsanin/OARscRNA/tree/main/vignettes).
...
To explore which cells/clusters have the most heterogeneity, we can visualize the results in a UMAP projection.

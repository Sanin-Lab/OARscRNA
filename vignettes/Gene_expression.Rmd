...
In this vignette we will explore what genes are associated with increased OAR scores. We will use our toy plasmacytoid dendritic cell dataset that you can download from our [github](https://github.com/davidsanin/OARscRNA/tree/main/vignettes).
...
```{r featureplot_score_deg, out.width="50%", fig.cap="Feature plot of OAR score"}
library(Seurat)
p1 <- FeaturePlot(

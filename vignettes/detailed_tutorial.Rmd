...
```{r patterns_found_mdp, out.width="100%", fig.cap="Missing Data Pattern Plot"}
...
```{r featureplot_score, out.width="50%", fig.cap="Feature plot of OAR score"}
library(Seurat)
p1 <- FeaturePlot(
...
```{r featureplot_genes, out.width="50%", fig.cap="Feature plot of results"}
library(Seurat)
p2 <- FeaturePlot(

...
As you can see, we are able to identify heterogeneity within each biological condition. Moreover, we can visualize these results in a UMAP projection of the using `Seurat::FeaturePlot()`.
